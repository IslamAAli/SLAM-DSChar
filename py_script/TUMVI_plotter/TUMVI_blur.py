...
# get the filenames 
blur_scores, labels     = ds_fns.filename_tumvi_creator("BLUR_SCORE")
blur_percent, labels    = ds_fns.filename_tumvi_creator("BLUR_PERCENT")
empty_labels            = [''] * len(labels)


vert_val = True
fig1 = plt.figure('TUM-VI Blur')
...
plt.tight_layout()
plt.savefig(dirname+"/../out_data/agg_figs/TUMVI_blur.png",bbox_inches='tight')
plt.show()