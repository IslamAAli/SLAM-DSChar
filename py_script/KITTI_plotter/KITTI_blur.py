...
# get the filenames 
blur_scores, labels     = ds_fns.filename_kitti_creator("BLUR_SCORE")
blur_percent, labels    = ds_fns.filename_kitti_creator("BLUR_PERCENT")
...
plt.tight_layout()
plt.savefig(dirname+"/../out_data/agg_figs/KITTI_blur.png",bbox_inches='tight')
plt.show()